          ...
          !(function (t, n) {
                ...
                function (e, t) {
                  T.fn[e] = function (n, r) {
                    ...
                    return (
                      ...
                      1 < this.length &&
                        (q[e] || T.uniqueSort(i), O.test(e) && i.reverse()),
                      this.pushStack(i)
                    );
                  };
                }
            ...
            (T.event = {
              ...
              remove: function (e, t, n, r, i) {
                ...
                if (v && (c = v.events)) {
                  ...
                  T.isEmptyObject(c) && K.remove(e, "handle events");
                }
              },
              dispatch: function (e) {
                var t,
                ...
                if (
                  ...
                  for (
                    a = T.event.handlers.call(this, c, l), t = 0;
            ...
            function Re(e, t, n, r) {
              ...
              if (
                ...
                for (s = (a = T.map(be(i, "script"), Oe)).length; d < f; d++)
                  (l = i),
                    d !== p &&
                      ((l = T.clone(l, !0, !0)),
                ...
                if (s)
                  for (
                    u = a[a.length - 1].ownerDocument, T.map(a, qe), d = 0;
                    d < s;
                    d++
                  )
                    (l = a[d]),
            ...
            function tt(e, t, n, r, i, o) {
              ...
              for (; a < 4; a += 2)
                "margin" === n && (c += T.css(e, n + oe[a], !0, i)),
                  r
                    ? ("content" === n &&
                        (c -= T.css(e, "padding" + oe[a], !0, i)),
                      "margin" !== n &&
                        (c -= T.css(e, "border" + oe[a] + "Width", !0, i)))
                    : ((c += T.css(e, "padding" + oe[a], !0, i)),
                      "padding" !== n
                        ? (c += T.css(e, "border" + oe[a] + "Width", !0, i))
            ...
            function ht(e, t, n) {
              ...
              return (
                ...
                T.fx.timer(
                  T.extend(c, { elem: e, anim: l, queue: l.opts.queue })
                ),
                l
              );
            }
            ...
            T.fn.extend({
              attr: function (e, t) {
                return _(this, T.attr, e, t, 1 < arguments.length);
              },
            ...
            T.fn.extend({
              prop: function (e, t) {
                return _(this, T.prop, e, t, 1 < arguments.length);
              },
                  ...
                  select: {
                    ...
                    set: function (e, t) {
                      for (
                        ...
                        ((r = i[a]).selected =
                          -1 < T.inArray(T.valHooks.option.get(r), o)) &&
                          (n = !0);
              ...
              T.extend({
                ...
                ajax: function (e, t) {
                  ...
                  p.ifModified &&
                    ...
                    T.etag[i] &&
                      P.setRequestHeader("If-None-Match", T.etag[i])),
            ...
            T.ajaxSetup({
              ...
              T.each(["top", "left"], function (e, t) {
                T.cssHooks[t] = _e(v.pixelPosition, function (e, n) {
                  if (n)
                    return (
                      (n = $e(e, t)), Be.test(n) ? T(e).position()[t] + "px" : n
                    );
                });
              }),
      ...
      (() => {
        ...
        var y = (function () {
          function e(t, n) {
            ...
            return this.initElement(t), this.initH5P(i, r, o);
          }
          var t, n, r, i, o, a;
          return (
            (t = e),
              ...
              },
              {
                ...
                value: function (e, t) {
                  ...
                  return (
                    ...
                    this.mainLibrary.preloadedCss &&
                      Array.prototype.push.apply(
                        a,
                        this.mainLibrary.preloadedCss.map(function (e) {
                          return ""
                            .concat(n.librariesPath, "/")
                            .concat(n.mainLibraryPath, "/")
                            .concat(e.path);
                        })
                      ),
                    this.mainLibrary.preloadedJs &&
                      Array.prototype.push.apply(
                        s,
                        this.mainLibrary.preloadedJs.map(function (e) {
                          return ""
                            .concat(n.librariesPath, "/")
                            .concat(n.mainLibraryPath, "/")
                            .concat(e.path);
